...
<body>
	<div class="interface">
		<div class="nav">
			<a class="logo"> <img
				src="<%=request.getContextPath()%>/img/icon.png">
			</a> <a class="username">Hola <%=nombre%></a>
					...
					<div class="content-about-table">
						<table class="table">
							...
							<tr class="tr-table">
								...
								<td class="td-table">N/A</td>
								<td class="td-table">
									<button title="Ver Alerta" class="button-action toggle">🔎</button>
									<button title="Eliminar Alerta" class="button-action delete">🗑️</button>
								</td>
							</tr>
							<tr class="tr-table">
								<td class="td-table">N/A</td>
			...
			<div class="grid-content-perfil">
				...
				<div class="content">
					...
					<div class="content-about-item">
						...
						<p class="content-text">Desarrollador: Andriu Joshua Rodriguez
							Correa | Alias ZekyyCZ</p>
							...
							<tr class="tr-table">
								...
								<td class="td-table">
									...
									<button title="Activar / Desactivar"
										class="button-action toggle">💡</button>
									<button title="Reiniciar Contraseña"
										class="button-action restart">🔑</button>
					...
					<div class="content-about-table">
						<table class="table-add">
							<tr>
								...
								<th class="th-table" colspan="3">Filtrar Departamento</th>
							</tr>
							<tr class="tr-table">
					...
					<div class="content-about-table">
						<table class="table-add">
							<tr>
								...
								<th class="th-table" colspan="3">Filtrar Pedidos</th>
							</tr>
							<tr class="tr-table">
